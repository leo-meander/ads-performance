...
// null; in per-ad mode `key` is the ad_id. AdState carries the ad's live
// delivery state — "right now", NOT the selected date window.
interface AdRow extends AdState {
  key: string
  account_id: string
  ad_id: string | null
  ad_name: string | null
